...
- 표준: `rounded-full border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 focus:border-indigo-400 focus:bg-white focus:shadow-[0_0_0_3px_rgba(99,102,241,0.12)]`. `focus:ring-2` idiom 금지. 사이드바 검색만 `rounded-xl` 허용.
