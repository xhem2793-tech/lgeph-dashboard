    ...
    <section className="rounded-xl transition-shadow duration-300 hover:shadow-md">
      <header className="flex items-baseline justify-between border-b border-gray-100 dark:border-gray-800 px-3.5 py-2.5">
        <a href="/economy" className="group flex items-baseline gap-1">
          <h2 className="text-[15px] font-bold tracking-tight text-gray-900 dark:text-gray-50 transition-colors duration-300 group-hover:text-indigo-600 dark:group-hover:text-indigo-400">{t("rail_title")}</h2>
                ...
                !c ? (
                  ...
                  <div key={c.key} className="mx-2.5 border-b border-dashed border-gray-300 dark:border-gray-700 last:border-b-0">
                    ...
                    >
                      <p
                        className={
                          "w-[104px] shrink-0 text-[12.5px] font-medium leading-snug text-gray-800 dark:text-gray-100 transition-colors duration-300 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 " +
                          (lang === "en" ? "truncate text-[12px]" : "truncate text-[12.5px]")
                        }
                      >
    ...
    <div className="pb-2.5 pt-2.5" style={{ animation: "fadeUp .35s cubic-bezier(.22,1,.36,1) both" }}>
      <div className="rounded-xl bg-[#f9fafb] p-3">
        <div className="flex items-center justify-between gap-2">
          <span className={(lang === "en" ? "text-[12px]" : "text-[12.5px]") + " font-medium text-gray-800 dark:text-gray-100"}>{pick(c.label, c.labelEn)}</span>
