...
function Soon({ label }: { label: string }) {
  return <div className="flex h-[280px] flex-col items-center justify-center rounded-xl border border-dashed border-gray-200 dark:border-gray-800 bg-gray-50/60 dark:bg-gray-900/60 text-[12px] text-gray-400"><b className="text-[13px] text-gray-500 dark:text-gray-400">{label}</b><span className="mt-1">데이터 준비 중</span></div>
}
