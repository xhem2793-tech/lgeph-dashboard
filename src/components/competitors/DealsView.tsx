...
import { peso, pmShopLabel, PmDrop, ListSearch, catLabel } from "@/components/competitors/shared"
    ...
    <div className="flex flex-col gap-3">
      ...
      <div style={{ display: "grid", gridTemplateRows: activated ? "1fr" : "0fr", opacity: activated ? 1 : 0, transition: "grid-template-rows .55s cubic-bezier(.22,1,.36,1), opacity .45s ease" }}>
        ...
        <table className="w-full min-w-[900px] table-fixed border-collapse text-[12px]">
          <colgroup>
            <col style={{ width: 60 }} /><col style={{ width: 180 }} /><col style={{ width: 78 }} /><col style={{ width: 96 }} /><col style={{ width: 60 }} /><col style={{ width: 80 }} />
