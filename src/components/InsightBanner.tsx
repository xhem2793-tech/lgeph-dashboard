  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <div className="min-w-0 flex-1 truncate text-[14px] text-gray-700 dark:text-gray-200">
      ...
      <div style={{ display: "grid", gridTemplateRows: open ? "1fr" : "0fr", transition: "grid-template-rows .36s cubic-bezier(.16,1,.3,1)" }}>
        <div className="overflow-hidden">
          <div className="border-t border-indigo-100/70 dark:border-indigo-500/25 px-4 pb-3.5 pt-3">
            <p className="text-[14px] leading-relaxed text-gray-700 dark:text-gray-200">{rich(banner.body)}</p>
            <p className="mt-2 flex items-start gap-1.5 text-[13.5px] leading-relaxed text-indigo-700 dark:text-indigo-300">
              <span className="mt-0.5 shrink-0 rounded bg-indigo-600 px-1.5 py-0.5 text-[10.5px] font-bold text-white">{banner.insightLabel || "LG 관점"}</span>
