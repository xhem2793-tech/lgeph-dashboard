...
function Ticker() {
  ...
  return (
    <div className="border-b border-gray-200 bg-gray-50 dark:border-gray-800 dark:bg-gray-900">
      <div className="mx-auto flex max-w-screen-2xl items-center gap-6 overflow-x-auto px-4 py-1.5 text-xs sm:px-6 lg:px-8">
        {items.map((it) => (
...
export function TopNav() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-gray-200 bg-white/90 backdrop-blur dark:border-gray-800 dark:bg-gray-950/90">
      <div className="mx-auto flex max-w-screen-2xl items-center justify-between px-4 py-2.5 sm:px-6 lg:px-8">
        <div className="flex items-center gap-8">
          <Link href="/overview" className="flex items-center gap-2">
            ...
            <span className="hidden text-sm font-semibold text-gray-900 dark:text-gray-50 sm:block">
              필리핀 시장 인텔리전스
            </span>
          </Link>
        ...
        <div className="flex items-center gap-3">
          <span className="hidden text-xs tabular-nums text-gray-500 dark:text-gray-400 sm:block">
            {today}
          </span>
          <span className="hidden rounded-md bg-gray-100 px-2 py-1 text-[11px] font-medium text-gray-600 dark:bg-gray-800 dark:text-gray-300 md:block">
            LGE-PH 경영기획
          </span>
        </div>
      </div>
