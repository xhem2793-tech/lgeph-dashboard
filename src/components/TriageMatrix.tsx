    ...
    <section className="animate-[fadeUp_.5s_ease] rounded-xl bg-[#f9fafb] p-4 sm:p-5">
      <header className="mb-3 flex flex-wrap items-baseline justify-between gap-2">
        <div className="flex items-baseline gap-2">
          <h2 className="text-[15px] font-bold tracking-tight text-gray-900 dark:text-gray-50">상황판</h2>
            ...
            {(rows ?? Array.from({ length: 4 })).map((r, i) => {
              ...
              return (
                <tr key={r.category} className="border-t border-gray-100 dark:border-gray-800">
                  <td className="py-1 pl-0.5 text-[12px] font-bold text-gray-900 dark:text-gray-50">
                    {r.category}
                  </td>
