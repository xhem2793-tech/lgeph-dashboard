  ...
  return (
    <section className="animate-[fadeUp_.5s_ease]">
      <header className="mb-2 flex items-baseline gap-2">
        <h2 className="text-[15px] font-bold tracking-tight text-gray-900 dark:text-gray-50">더 파고들기</h2>
        ...
        {(cards ?? Array.from({ length: 4 })).map((c, i) =>
          !c ? (
            ...
            >
              ...
              <p className="mt-1 text-[15px] font-bold leading-none tracking-tight text-gray-900 dark:text-gray-50">
                {c.value}
              </p>
