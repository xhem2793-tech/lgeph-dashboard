...
export const DICT = {
  ...
  search_ph: { ko: "지표·뉴스·키워드 검색", en: "Search indicators / news" },
  org: { ko: "LGE-PH 경영기획", en: "LGE-PH Strategy" },
  brief_title: { ko: "금주 브리핑", en: "This Week" },
  brief_evidence: { ko: "근거", en: "Evidence" },
  brief_empty: { ko: "오늘 초안 없음 — 아직 생성 전", en: "No draft yet today" },
  ...
  d_basis: { ko: "기준 · 전년 동기 대비", en: "as of · YoY" },
  ...
  rail_fail: { ko: "지표를 불러오지 못함 · 확인 필요", en: "Load failed · check" },
  prev_year: { ko: "전년", en: "Prev yr" },
  cur_year: { ko: "현재", en: "Current" },
  news_title: { ko: "주요 뉴스", en: "Top News" },
  news_sub: { ko: "경제·산업·B2B", en: "Econ · Ind · B2B" },
