  ...
  return (
    <main className="w-full px-6 pb-10 pt-4 sm:px-8 lg:px-10">
      ...
      <div className={"grid items-start gap-6 lg:gap-7 " + (mode === "card" ? "lg:grid-cols-[270px_minmax(0,1fr)_270px]" : "lg:grid-cols-[270px_minmax(0,1fr)]")}>
        <aside className="h-fit lg:sticky lg:top-[61px] scroll-soft lg:max-h-[calc(100vh-72px)] lg:overflow-y-auto lg:border-r lg:border-gray-100 lg:dark:border-gray-800/70 lg:pr-6" style={{ animation: "fadeUp .5s ease both" }}>
        ...
        {mode === "card" && (
          <aside className="hidden lg:block lg:sticky lg:top-[61px] scroll-soft lg:max-h-[calc(100vh-72px)] lg:overflow-y-auto lg:border-l lg:border-gray-100 lg:dark:border-gray-800/70 lg:pl-6" style={{ animation: "fadeUp .5s ease both" }}>
            <AgendaCard />
          </aside>
        )}
      </div>
