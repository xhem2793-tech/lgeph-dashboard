...
export default function Error({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 px-6 text-center">
      ...
      <div>
        <h2 className="text-[18px] font-bold text-gray-900 dark:text-gray-50">이 페이지를 불러오는 중 문제가 발생했습니다</h2>
        <p className="mt-1 text-[14px] text-gray-500 dark:text-gray-400">일시적 오류일 수 있습니다. 다시 시도하거나, 계속되면 담당자에게 알려주세요.</p>
