    ...
    <main className="mx-auto max-w-[1536px] px-4 pb-12 pt-4 sm:px-6">
      ...
      <div className="grid gap-4 lg:grid-cols-[210px_minmax(0,1fr)]">
        ...
        <div className="min-w-0" style={{animation:"fadeUp .5s ease both"}}>
          <div className="mb-3 flex items-start gap-3 rounded-lg bg-gray-50 px-3.5 py-2.5"><div className="mt-0.5 flex shrink-0 items-center gap-1.5"><span className="text-[10px] font-bold text-indigo-600">상황 읽기</span><span className="rounded-full bg-indigo-50 px-1.5 py-0.5 text-[9px] font-semibold text-indigo-600">{monthSel ? ymLabel(monthSel) : "전체 기간"}</span></div>{sitOpen ? (<div className="min-w-0 flex-1"><p className="text-[12.5px] leading-relaxed text-gray-700">성수기 진입과 함께 경쟁사 광고가 <b className="text-gray-900">TV·에어컨</b>에 집중되는 흐름. <b className="text-gray-900">Samsung</b>은 비전 AI TV를 대형 할인+사운드바로 <b className="text-gray-900">가격 공세</b>, <b className="text-gray-900">TCL</b>은 인버터 에어컨 신모델을 무이자 할부로 밀며 <b className="text-gray-900">신제품+금융</b> 카드, <b className="text-gray-900">Hisense</b>는 월드컵 스폰서십으로 <b className="text-gray-900">브랜딩</b> 상향을 시도.</p><p className="mt-1 text-[12.5px] leading-relaxed text-indigo-700"><b>LG 대응</b> — TV 성수기 프로모 강도·번들 점검, 에어컨 할부조건 경쟁력 확인, 중가 브랜드 상향 시도 주시.</p></div>) : (<div className="min-w-0 flex-1 truncate text-[12.5px] leading-snug text-gray-700"><b className="font-semibold text-gray-900">성수기 TV·에어컨 경쟁 집중</b> — Samsung 가격딜·TCL 신모델 무이자·Hisense 월드컵 브랜딩. <span className="font-medium text-indigo-700">LG: TV 프로모·에어컨 할부 점검</span></div>)}<button onClick={() => setSitOpen((v) => !v)} className="shrink-0 self-center text-[11px] font-medium text-gray-400 hover:text-indigo-600">{sitOpen ? "접기 ▴" : "더보기 ▾"}</button><span className="shrink-0 self-center whitespace-nowrap text-[9px] text-gray-400">AI · 전수 아님</span></div>
